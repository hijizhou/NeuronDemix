...
static __Pyx_memviewslice __pyx_f_7trefide_7solvers_5space_10lagrangian_ldr2_tv(size_t const , size_t const , __Pyx_memviewslice, double const , int __pyx_skip_dispatch); /*proto*/
...
static __Pyx_memviewslice __pyx_f_7trefide_7solvers_5space_10lagrangian_ldr2_tv(size_t const __pyx_v_d1, size_t const __pyx_v_d2, __Pyx_memviewslice __pyx_v_y, double const __pyx_v_lambda_tv, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_status;
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dc_double(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __Pyx_RefNannySetupContext("ldr2_tv (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lambda_tv)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_y = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_y.memview)) __PYX_ERR(0, 32, __pyx_L3_error)
...
static PyMethodDef __pyx_methods[] = {
  {"ldr2_tv", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7trefide_7solvers_5space_10lagrangian_1ldr2_tv, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7trefide_7solvers_5space_10lagrangian_ldr2_tv},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initlagrangian(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initlagrangian(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_lagrangian(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_lagrangian(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_lagrangian(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'lagrangian' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_lagrangian(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init trefide.solvers.space.lagrangian", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
